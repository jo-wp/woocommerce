...
class WC_Customer_Data_Store extends WC_Data_Store_WP implements WC_Customer_Data_Store_Interface, WC_Object_Data_Store_Interface {
	...
	public function create( &$customer ) {
		...
		$customer->set_date_created( wc_string_to_timestamp( $wp_user->user_registered ) );
	...
	public function read( &$customer ) {
		...
		$customer->set_props( array(
			...
			'date_created'       => 0 < $user_object->user_registered ? wc_string_to_timestamp( $user_object->user_registered ) : null,
